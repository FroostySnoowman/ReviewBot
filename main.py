...
initial_extensions = [
                      'cogs.commands.review',
                      'cogs.functions.sqlite'
                      ]

class ReviewBot(commands.Bot):
    def __init__(self):
        super().__init__(command_prefix=commands.when_mentioned_or('.'), owner_ids=[503641822141349888, 156479191745822720], intents=intents, activity=_activity, status=_status)
